...
- Login Page
    ...
    <img src="/reportimg/1.png" width = 400px>

- SignUp Page

    <img src="/reportimg/2.png" width = 400px>
...
- Friend Page
    ...
    <img src="/reportimg/3.png" width = 400px>
...
- Friend Requests
    ...
    <img src="/reportimg/9.png" width = 400px>

    <img src="/reportimg/10.png" width = 400px>

    <img src="/reportimg/11.png" width = 400px>

- Group Page

    When you don't have any groups, it will display "no groups". You can create a new group with the button "Add".

    <img src="/reportimg/12.png" width = 400px>
    ...
    <img src="/reportimg/13.png" height = 400px>
    <img src="/reportimg/14.png" height = 400px>

    A new group is then created !

    <img src="/reportimg/15.png" width = 400px>

    Click on the group and you will go to the chat page. The title above is the group name.

    <img src="/reportimg/16.png" width = 400px>

    Type in any thing and you can also send pictures.

    <img src="/reportimg/17.png" width = 400px>

    Friends that are added into the group will also see the group on their page.

    <img src="/reportimg/18.png" height = 300px>
    <img src="/reportimg/19.png" height = 300px>

    And everyone can chat now!

    <img src="/reportimg/20.png" width = 400px>
...
- Chat with single friend
    ...
    <img src="/reportimg/21.png" width = 400px>
